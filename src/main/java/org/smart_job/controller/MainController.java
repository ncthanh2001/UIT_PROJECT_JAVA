...
//        showDashboard(); // Default show dashboard
    ...
    public void showDashboard() {
        ...
        dashboardController.setNavigateToJobTracker(this::showJobTracker);
        dashboardController.setNavigateToCVAnalysis(this::showCVAnalysis);

        view.setContent(panel);
    }

    public void showListJobs() {
        view.setVisible(true);
